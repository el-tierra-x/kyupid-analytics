...
class TopProAreas extends React.PureComponent {
      ...
      <Table size="small" aria-label="a dense table">
        <TableHead>
          <TableRow style={{ padding: '16px 0px', height: 60 }}>
            ...
            <TableCell align="center">Total Pro Users</TableCell>
            <TableCell align="right">Pro User Percentage</TableCell>
          </TableRow>
        </TableHead>
        ...
        <TableBody>
          {
            slicedData?.map((item) => {
              const userPerc = (item?.proUsers / item?.totalUsers) * 100
              return (
                <TableRow key={item?.areaId}>
                  ...
                  <TableCell align="center">{item?.proUsers}</TableCell>
                  <TableCell align="right">{userPerc.toFixed(2)}%</TableCell>
                </TableRow>
              );
            })
          }
